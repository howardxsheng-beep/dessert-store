                ...
                <li className="mt-[30px] grid max-w-[315px] w-full  border-light-green border-b pb-2 sm:max-w-[620px] sm:flex sm:h-[130px] sm:items-center sm:gap-3 md:gap-7 xl:gap-10">
                    <div className="w-full max-w-[157px] aspect-[157/106] sm:aspect-[1/1] sm:h-[110px] sm:w-auto  ">
                     ...
                     <div className="  flex  flex-col  ml-4 sm:flex-row sm:flex-1 sm:h-[110px] sm:ml-0 sm:min-w-0">
                        <p className="text-dark-green flex text-xl sm:justify-center sm:items-center sm:w-[110px] sm:mr-10  ">焦糖馬卡龍<br/>NT$ 450</p>
                        <div className="flex  flex-nowrap sm:items-center ">
                            <div className="text-base basis-[clamp(28px,40vw,48px)]  aspect-square flex justify-center items-center border border-light-green sm:w-12 sm:h-12">-</div>
                            <div className="text-base basis-[clamp(28px,40vw,48px)]  flex justify-center items-center border border-light-green -ml-px sm:w-12 sm:h-12">1</div>
                            <div className="text-base basis-[clamp(28px,40vw,48px)]  flex justify-center items-center border border-light-green -ml-px sm:w-12 sm:h-12">+</div>
                        </div>
                    </div>
                    
                    <div className="h-[45px] col-span-2 mt-3 flex items-center justify-end text-dark-green font-semibold border-light-green border-t sm:border-0 sm:h-[130px] sm:mt-0 sm:ml-auto whitespace-nowrap">NT$ 900
                        <img className="hidden sm:ml-[10px] md:ml-[25px] xl:ml-[40px] sm:block" src="images/delete.png"></img>
                    </div>
                </li>
                <li className="mt-[30px] grid max-w-[315px] w-full  border-light-green border-b pb-2 sm:max-w-[620px] sm:flex sm:h-[130px] sm:items-center sm:gap-3 md:gap-7 xl:gap-10">
                    <div className="w-full max-w-[157px] aspect-[157/106] sm:aspect-[1/1] sm:h-[110px] sm:w-auto  ">
